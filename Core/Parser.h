...
bool			ps_get_2f( script_state_t *ss, const char *name, float val[2], float defVal[2] = 0 );
bool			ps_get_3f( script_state_t *ss, const char *name, float val[3], float defVal[3] = 0 );
bool			ps_get_4f( script_state_t *ss, const char *name, float val[4], float defVal[4] = 0 );
